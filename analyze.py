...
parser.add_argument("-g", "--graph", action='store_const', const=True, default=False, help="Enter a maximum price you are willing to spend", required=False)

args = parser.parse_args()

listings = time_func("analyze the listing", analyze__and_display_listing, args.url, args.maxprice, args.all, [])
